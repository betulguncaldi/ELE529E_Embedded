...
| FR10 | The I2C communication bus shall be protected using a FreeRTOS Mutex mechanism to prevent shared resource conflicts and data corruption.                   | High     |
...
| FR12 | The system shall transmit the processed distance data and system status messages to an external PC via the UART interface at a baud rate of 115200 bps.   | Medium   |
